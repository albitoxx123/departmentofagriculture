...
<div id="carousel" class="carousel slide" data-ride="carousel"
    ...
    <div class="container">
      <div class="row justify-content-center my-5 text-center">
         <h1 class="font-weight-bold mb-3">CAUAYAN, NEGROS OCCIDENTAL FARMER'S TOP STORIES</h1>
  ...
  <!--div class="border-top border-dark w-100 mx-auto my-3"></div>
    ...
    <div class="container my-5">
      ...
      <div class="col-lg-8"><img src="img/tp4.jpg" alt="" class="w-100"></div><br>
      <div class="col-lg-8"><img src="img/tp1.jfif" alt="" class="w-100"></div><br>
      <div class="col-lg-8"><img src="img/tp3.png" alt="" class="w-100"></div><br>
      <div class="col-lg-8"><img src="img/tp2.jpg" alt="" class="w-100"></div>
