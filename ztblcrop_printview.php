...
if (isset($_GET['gain_loss'])) { $gainloss =$_GET['gain_loss']; }
  ...
  $query = mysqli_query($con, "SELECT * FROM tblcrop where (farmer_name like  '%$searchq%' or brgy like  '%$searchq%' or  feedback like  '%$searchq%'  or gain_loss like  '%$searchq%') and (gain_loss like '%$gainloss%')");
...
<?php
  ...
  $sql = "SELECT * FROM tblcrop where (farmer_name like  '%$searchq%' or brgy like  '%$searchq%' or  feedback like  '%$searchq%'  or gain_loss like  '%$searchq%') and (gain_loss like '%$gainloss%') order by id desc";
$result = $con-> query($sql);
if ($result-> num_rows > 0) {
  while($row = $result-> fetch_assoc()){
    $id  = $row["id"];
