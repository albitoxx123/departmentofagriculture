...
<div style="text-align: right;">
  <a class="btn btn-primary" href="tblstaff_printview.php">Print View</a>
</div>
<div class="col-md-12">
...
if ($result-> num_rows > 0) {
 ...
 ?>
  <tr>
    ...
    <td><a class="btn btn-success mr-3" href="update_staff.php?action=update_staff & rn=<?php echo $id ?>">UPDATE</a>
    <a class="btn btn-success mr-3" href="update_staff.php?action=update_staff & rn=<?php echo $id ?>">UPDATE</a>
   </td>
